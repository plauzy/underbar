  ...
  _.invoke = function(collection, functionOrKey, args) {
    ...
    if (typeof(functionOrKey) === 'string') {
      _.each(collection, function(item) {
        // console.log(  eval( "'" + item + "'." functionOrKey + "()")  );
        results.push(eval("'" + item + "'." + functionOrKey + "()"))
        // console.log(eval("'" + item + "'." functionOrKey + "()"))
        // console.log(results)
      })
    } else {
...
///submit pull request
  ...
  _.contains = function(collection, target) {
    ...
    return _.reduce(collection, function(wasFound, item) {
      // console.log("Was found is " + wasFound)
      // console.log("item is " + item)
      if (wasFound) {
        return true;
      }
      return item === target; /// which will become wasFound, or if its last element will return true
    }, false);
  };
  ...
  _.sortBy = function(collection, iterator) {
    // var newArray = []
    // _.each(collection, function(item) {
    //   if (iterator(item) > newArray)
    // })
    var sorted = _.map(collection, function(item) {
        debugger
